...
export default function Page({ cvData }) {
  ...
  const mobileContacts = (
    <div className={styles.mobileContacts}>
      <a href={`mailto:${personal.email}`} className={styles.mobileContactLine}>
        {personal.email}
      </a>
      <div className={styles.mobileContactLine}>
        {personal.location} · Originară din {personal.origin}
      </div>
      <div className={styles.mobileContactLine}>{personal.phone}</div>
      <div className={styles.mobileContactLine}>
    ...
    <div className={styles.page}>
      ...
      >
        <div className={styles.coachContent}>
          ...
          <div className={styles.coachText}>Swipe stanga-dreapta</div>
        </div>
      </div>
    </div>
  );
